...
func (g *IRGen) VisitFile(file *ast.File) {
...
func (g *IRGen) VisitDecl(decl *ast.Decl) {
	ast.WalkDecl(decl, g)
}

func (g *IRGen) VisitType(typ *ast.Type) {
	ast.WalkType(typ, g)
}

func (g *IRGen) VisitFun(astFun *ast.Fun) {
...
func (g *IRGen) VisitFunParam(param *ast.FunParam) {
	ast.WalkFunParam(param, g)
}

func (g *IRGen) VisitBlock(block *ast.Block) {
	g.enterScope()
	ast.WalkBlock(block, g)
	g.leaveScope()
	code := "void"
...
func (g *IRGen) VisitExpr(expr *ast.Expr) {
	ast.WalkExpr(expr, g)
}

func (g *IRGen) VisitAssign(assign *ast.Assign) {
	ast.WalkAssign(assign, g)
...
func (g *IRGen) VisitCall(call *ast.Call) {
	ast.WalkCall(call, g)
...
func (g *IRGen) VisitIdent(ident *ast.Ident) {
...
func (g *IRGen) VisitName(name *ast.Name) {
	g.setCode(name.ID, name.Name)
}

func (g *IRGen) VisitInt(int_ *ast.Int) {
	g.setCode(int_.ID, "%d", int_.Value)
}

func (g *IRGen) VisitString(str *ast.String) {
...
func (g *IRGen) VisitRef(expr *ast.Ref) {
	ident := expr.Ident
	if symbol, ok := g.scope.Lookup(ident.Name); ok {
...
func (g *IRGen) VisitDeref(expr *ast.Deref) {
	ast.WalkDeref(expr, g)
	inner := expr.Expr
...
func (g *IRGen) VisitVar(var_ *ast.Var) {
	ast.WalkVar(var_, g)
...
func GenIR(file *ast.File, typeEnv *check.TypeEnv) (string, error) {
	g := NewIRGen(typeEnv)
	g.VisitFile(file)
	g.write(builtins)
