...
@str_misaligned_pointer.data = private constant [18 x i8] c"misaligned pointer"
@str_misaligned_pointer = private constant %Str { { ptr, i64 } { ptr @str_misaligned_pointer.data, i64 18 } }
